...
const benefits = ["Specialized in e-commerce conversion funnels", "Product catalog optimization for Meta", "Dynamic retargeting campaigns", "Shopping cart abandonment strategies", "Seasonal campaign planning", "Multi-platform attribution tracking"];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            ...
            <h2 className="text-4xl md:text-6xl font-bold leading-tight">
              Built for <span className="text-primary animate-glow">
Online Stores</span>
            </h2>
            ...
            <div className="space-y-4">
              {benefits.map((benefit, index) => <div key={index} className={`flex items-start gap-4 transition-all duration-500 delay-${index * 100}`} style={{
