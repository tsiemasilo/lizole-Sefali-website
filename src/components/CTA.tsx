...
const CTA = () => {
  return <section id="contact" className="py-24 relative overflow-hidden scroll-mt-28">
      ...
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[150px] animate-pulse" style={{
      animationDelay: '1s'
    }} />
...
E-Commerce Store?</span>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto animate-fade-in" style={{
          ...
          {/* Trust indicators */}
          <div className="pt-12 flex flex-col md:flex-row items-center justify-center gap-8 text-muted-foreground animate-fade-in" style={{
